...
## POSSESS
server -> client  
(returns player pawn playerId, once on the start of game)
```json
{
   "topic": "POSSESS",
   "data": 123
...
```json
{
   ...
   "data":
   {
       "objects":[{"position":{"x":16.0,"y":12.0},"playerId":16,"type":"Wall"},{"position":{"x":32.0,"y":32.0},"playerId":213,"velocity":0.05,"maxBombs":1,"bombPower":1,"speedModifier":1.0,"type":"Pawn"},{"position":{"x":32.0,"y":352.0},"playerId":214,"velocity":0.05,"maxBombs":1,"bombPower":1,"speedModifier":1.0,"type":"Pawn"}],
       "gameOver":false
   }
}
```
